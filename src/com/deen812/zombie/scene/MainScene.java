	...
	//	this.getResources().getString(R.string.app_name)
		Sprite btn_exit2  = new Sprite(mConst.CAMERA_WIDTH - 80 , 30, mRes.btn_exit) {
            ...
            public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float X, float Y)  {	 
              ...
              // 	 game.sceneManager.setCurrentScene(AllScenes.MENU);
               	 ...
               	 if( (mConst.COUNT_EXIT == 5  ||  mConst.COUNT_EXIT == 15||   mConst.COUNT_EXIT == 25) && mConst.F_SEND_REV == 0 ) {
               		 game.sceneManager.setCurrentScene(AllScenes.REVWIES);
               	 }
               	 else 
      ...
      */
		   ...
		   //   this.game.getResources().getString(R.string..app_name);
		     ...
		     Text t2 = new Text(0, 20, Resource.getInstance().mFont_Plok, str);
		     t2.setPosition(mConst.CAMERA_WIDTH/2 - t2.getWidth()/2, 30);
		     t2.setScale(1.4f);
		      ...
		      Sprite btn_info  = new Sprite(160 , 320, mRes.btn_info) {
		             ...
		             public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float X, float Y)  {	 
		              ...
		              //  	 game.sceneManager.setCurrentScene(AllScenes.HELP);
		                ...
		                //	 main.rateApp();
		                	// game.sceneManager.setCurrentScene(AllScenes.REVWIES);
		                // game.sceneManager.setCurrentScene(AllScenes.THANKS);
		                 }
